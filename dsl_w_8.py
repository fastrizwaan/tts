...
class MainWindow(Adw.ApplicationWindow):
            ...
            for dname, defs, color in dict_data:
                ...
                for i, d in enumerate(defs):
                    ...
                    if m_content:
                        ...
                        # Check if the content inside [mX] starts with a number
                        # This could be plain "1." or formatted like "[b]1.[/b]"
    ...
    def render_dsl_text(self, raw, is_main=False):
        ...
        # This handles both plain "1. " and formatted "[b]1.[/b] " patterns
        if is_main:
            t = re.sub(r'^\d+\.\s+', '', t)
