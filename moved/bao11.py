...
class Win(Adw.ApplicationWindow):
    ...
    def apply_column_layout(self, selected_column_index):
        ...
        function smoothScrollTo(xTarget) {{
            ...
            const duration = 400; // Increased duration for smoother animation
        ...
        document.addEventListener('keydown', function(e) {{
            ...
            switch(e.key) {{
                ...
                case 'PageUp':
                    e.preventDefault();
                    // Move by one full visible page width
    ...
    def update_column_count_in_js(self):
        ...
        cancellable = None
        self.webview.evaluate_javascript(js_code, -1, cancellable, None, None)
