...
class EPubViewer(Adw.ApplicationWindow):
    ...
    def display_page(self):
        ...
        for link in soup.find_all('a', href=True):
            ...
            # Try matching several candidate forms to find the corresponding item in the epub
            ...
            if matched:
                ...
                if os.path.exists(extracted):
                    ...
                    continue
            # If not matched, attempt to resolve as relative file on disk (base URI will help)
            # leave href alone; base URI provided when loading HTML will allow WebKit to resolve it
