...
class EPUBWindow(Adw.ApplicationWindow):
    ...
    def setup_toolbar(self):
        ...
        # notify::selected is correct for Gtk.DropDown in GTK4
        ...
        col_adj = Gtk.Adjustment(value=self.app.columns, lower=1, upper=10, step_increment=1)
        ...
        cw_adj = Gtk.Adjustment(value=self.app.column_width, lower=50, upper=500, step_increment=10)
    ...
    def apply_layout(self):
        ...
        # (previous code passed an int for `world`, which prevented execution)
        try:
