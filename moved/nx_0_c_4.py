...
class EPUBWindow(Adw.ApplicationWindow):
    ...
    def apply_layout(self):
        ...
        if columns > 1:
            # Total width = (column_width * columns) + (gap * (columns-1)) + (margin * 2)
            total_width = (col_width * columns) + (column_gap * (columns - 1)) + (margin * 2)
            ...
            css = f"""
                ...
                body {{
                    ...
                    min-height: calc(100vh - {margin * 2}px) !important;
    ...
    def scroll_viewport(self, direction: int):
        ...
        if self.app.columns == 1:
            ...
            new_val = v_adj.get_value() + direction * page * 0.9  # 90% overlap
            ...
            new_val = h_adj.get_value() + direction * page_size * 0.95  # 95% scroll
