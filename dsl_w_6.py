...
class MainWindow(Adw.ApplicationWindow):
    ...
    def render_dsl_text(self, raw, is_main=False):
        ...
        t = re.sub(r'\[m3\](.*?)\[/m\]', r'\1', t, flags=re.DOTALL)
        ...
        # Handle links <<word>> - make them clickable for future search
        t = re.sub(r"<<(.*?)>>", r'<a href="#" class="dict-link" onclick="window.searchWord(\'\1\'); return false;">\1</a>', t)
