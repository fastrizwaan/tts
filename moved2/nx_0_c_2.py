...
class EPUBViewer(Adw.Application):
    def __init__(self):
        ...
        # ✅ NEW: Separate property for column gap
        self.column_gap = 20
...
class EPUBWindow(Adw.ApplicationWindow):
    ...
    def setup_toolbar(self):
        ...
        # Margin (Applies to all four sides of content)
    ...
    def on_open_clicked(self, button):
        ...
        # Correctly populate Gio.ListStore
    ...
    def apply_layout(self):
        ...
        column_gap = self.app.column_gap # ✅ USE new variable
        ...
        css = f"""
            ...
            * {{
            ...
            html, body {{
                ...
                height: 100%;
                margin: 0 !important;
                /* ✅ FIX: margin applies to all four sides */
                ...
                column-gap: {column_gap}px !important; /* ✅ Use separate column_gap */
    ...
    def on_column_gap_changed(self, spin):
        # ✅ NEW: Handler for column gap change
