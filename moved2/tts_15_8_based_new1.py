...
class EpubViewer(Adw.ApplicationWindow):
    ...
    def on_sidebar_visibility_changed(self, split_view, pspec):
        ...
        if self.current_book and self.chapters:
            ...
            self.sidebar_toggle_timeout_id = GLib.timeout_add(100, self._on_sidebar_toggle_complete)
    ...
    def _on_sidebar_scroll_info(self, webview, result, user_data):
        """Handle scroll info and update layout"""
        # Recalculate dimensions based on new available width
        self.calculate_column_dimensions()
        
        # Update the CSS to reflect new column dimensions
        self._update_column_css()
        
        # Update navigation after a short delay
