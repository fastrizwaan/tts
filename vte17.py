    ...
    def _on_draw(self, area, cr, width, height):
        ...
        while line_index < len(wrapped_lines_data) and visual_line_counter < self.visible_lines + 20:
            ...
            for segment_index, (seg_line_num, seg_start_col, seg_end_col) in enumerate(wrapped_segments):
                ...
                if self.buffer.syntax_highlight and logical_line_num < self.buffer.total_lines and not (self.editing and logical_line_num == self.edit_line):
                    # Only use syntax highlighting if NOT editing this line
                    ...
                    # No syntax highlighting OR editing this line - render normally
                    layout = self.create_pango_layout("")
                    layout.set_font_description(self.font_desc)
                    layout.set_text(segment_text)
                    # normal text color
