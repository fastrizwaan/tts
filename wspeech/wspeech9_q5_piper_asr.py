    ...
    def update_highlight(self):
        try:
            ...
            if current_word_idx >= 0 and current_word_idx < len(self.word_timings):
                ...
                # This pattern matches words with common punctuation that might appear within or around them
                # Includes: regular quotes ', ", smart quotes ‘ ’ “ ”, hyphens, etc.
                # \w matches word characters (letters, digits, underscore)
                # [^\w\s] matches any character that is NOT a word character or whitespace (for punctuation)
                # The + quantifier means one or more of the preceding character class
