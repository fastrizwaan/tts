    ...
    def load_html(self):
        ...
        <div class="page-container" style="
            ...
            <div class="page">
                ...
                <h2>Column Breaking</h2>
                
                <p>The CSS includes break-after: avoid for headings and break-inside: avoid-column for paragraphs. This prevents awkward breaks that would split headings from their following content or cut paragraphs in the middle, maintaining readability.</p>
                
                <p>These column breaking controls are essential for creating professional-looking multi-column layouts that respect content boundaries and maintain visual coherence across the reading experience.</p>
