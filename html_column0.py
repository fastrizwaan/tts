...
class HtmlViewerWindow(Adw.ApplicationWindow):
    def __init__(self, app):
        ...
        self.set_title("HTML Multi-Column Viewer")

        # ---------------- ToolbarView + Header ----------------
        toolbar_view = Adw.ToolbarView()
        self.set_content(toolbar_view)

        header = Adw.HeaderBar(title_widget=Gtk.Label(label="HTML Multi-Column Viewer"))
    ...
    def load_html(self):
        ...
        <body>
        """ + "<p>" + ("Lorem ipsum dolor sit amet, consectetur adipiscing elit. " * 120) + "</p></body></html>"
