...
class HtmlViewerWindow(Adw.ApplicationWindow):
    ...
    def on_margin_changed(self, spin_row, param):
        ...
        (function() {{
            ...
            if (container && page) {{
                ...
                var pageHeight = window.innerHeight - {top} - {bottom};
                page.style.height = pageHeight + 'px';
                
                console.log('Margins updated:', {{top: {top}, bottom: {bottom}, left: {left}, right: {right}}});
                console.log('Page height set to:', pageHeight + 'px');
            }}
        }})();
        """
    ...
    def load_html(self):
        ...
        window.addEventListener('DOMContentLoaded', function() {
            ...
            var topMargin = parseFloat(computed.paddingTop);
            var bottomMargin = parseFloat(computed.paddingBottom);
            var pageHeight = window.innerHeight - topMargin - bottomMargin;
            page.style.height = pageHeight + 'px';
