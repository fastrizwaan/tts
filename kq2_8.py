...
class MainWindow(Adw.ApplicationWindow):
    ...
    def on_prev_clicked(self, button):
        ...
        if hasattr(self.app, 'current_sentence_index') and self.app.current_sentence_index > 0:
            self.start_playback_from_position(self.app.current_sentence_index - 1)

    def on_next_clicked(self, button):
        """Play next sentence"""
        if hasattr(self.app, 'current_sentence_index') and self.app.current_sentence_index < len(self.app.sentences) - 1:
            self.start_playback_from_position(self.app.current_sentence_index + 1)
