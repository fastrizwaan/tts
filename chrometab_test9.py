...
TAB_CSS = """
/* ===== Chrome-style tabs with SHORT vertical separators ===== */
...
.chrome-tab {
    ...
    /* Short separator as a centered vertical bar */
    background-image: linear-gradient(
        to bottom,
        alpha(@window_fg_color, 0.15),
        alpha(@window_fg_color, 0.15)
    );

    background-repeat: no-repeat;

    /* Thickness = 1px, Height = 6px */
...
/* First tab: no separator */
.chrome-tab:first-child {
    background-image: none;
}

/* Hover hides separator */
.chrome-tab:hover {
    background-color: alpha(@window_fg_color, 0.1);
    background-image: none;
}

/* Active hides separator */
.chrome-tab.active {
...
/* Hide NEXT tab's separator when current hovered */
.chrome-tab:hover + .chrome-tab {
    background-image: none;
}

/* Hide NEXT tab's separator when current active */
