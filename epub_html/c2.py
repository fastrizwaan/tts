...
class EpubViewer(Adw.ApplicationWindow):
    ...
    def setup_ui(self):
        ...
        # Connect keyboard events for column navigation
        self.setup_keyboard_navigation()
        
    def setup_keyboard_navigation(self):
        """Setup keyboard navigation for column movement"""
        # Add key controller to the window for global key handling
    ...
    def on_key_pressed(self, controller, keyval, keycode, state):
        ...
        # Let the WebView handle the keyboard events through JavaScript
        # This is just a fallback for when WebView doesn't have focus
        if keyval in [65361, 65362, 65363, 65364]:  # Arrow keys
    ...
    def process_chapter_content(self, content, item):
        ...
        <script>
        // Keyboard navigation for column scrolling
        document.addEventListener('keydown', function(event) {{
            const columnWidth = {self.column_width + self.column_gap};
            ...
            switch(event.key) {{
                ...
                case 'PageUp':
                case 'ArrowLeft':
                    newScroll = Math.max(currentScroll - columnWidth, 0);
                    event.preventDefault();
                    break;
                ...
                case 'End':
                    newScroll = document.body.scrollWidth - window.innerWidth;
                    event.preventDefault();
                    break;
            }}
        ...
        // Snap to column on manual scroll
        let scrollTimeout;
        window.addEventListener('scroll', function() {{
            ...
            scrollTimeout = setTimeout(function() {{
                ...
                const targetColumn = Math.round(currentScroll / columnWidth);
        ...
        // Focus document for keyboard events
