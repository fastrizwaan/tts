...
class EpubViewer(Adw.ApplicationWindow):
    ...
    def process_chapter_content(self, content, item):
        self.calculate_column_dimensions()
        # Determine if columns should be applied based on mode and count
        apply_columns = True
        if self.column_mode == 'fixed' and self.fixed_column_count <= 1:
            apply_columns = False
        elif self.column_mode == 'width' and self.actual_column_width <= 1: # Check actual width too
            apply_columns = False
        ...
        body {{
            ...
            overflow-y: hidden; /* Vertical scroll is hidden for multi-column */
            box-sizing: border-box;
        }}
        /* Adjust body styles for single column mode */
        body.epub-single-col {{
            ...
            column-width: auto;
            column-gap: 0;
            column-fill: auto; /* Not applicable, but set explicitly */
        }}
        ...
        """
        # Inject column mode and count into the JavaScript environment
        ...
        document.addEventListener('DOMContentLoaded', function() {{
            ...
            function applySingleColumnLayout() {{
                ...
                body.classList.remove('epub-multicol'); // If this class was added elsewhere
            ...
            function applyMultiColumnLayout() {{
                ...
                body.classList.add('epub-multicol'); // Optional: for identification
                ...
                body.style.height = `calc(100vh - {self.column_padding * 2}px)`; // Or rely on CSS
