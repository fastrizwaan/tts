...
class ViewerWindow(Adw.ApplicationWindow):
    ...
    def apply_column_layout(self, columns):
        ...
        (function() {{
            ...
            // make wrapper use the viewport height and scroll vertically
            ...
            if (cols <= 1) {{
                ...
                wrapper.style.columnRule = '';
                wrapper.style.columnFill = '';
            }} else {{
                wrapper.style.columnCount = String(cols);
                wrapper.style.columnGap = '20px';
                wrapper.style.columnRule = '1px solid rgba(0,0,0,0.08)';
                wrapper.style.columnFill = 'balance';
            }}
        }})();
        """
        try:
