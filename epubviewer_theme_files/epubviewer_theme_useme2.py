...
class EPubViewer(Adw.ApplicationWindow):
    ...
    def apply_theme(self, theme_name):
        ...
        # Remove all old theme providers
        try:
            for old_provider in [_css_light_provider, _css_dark_provider, _hover_light_provider, _hover_dark_provider, _dark_provider]:
                try:
        ...
        if hasattr(self, 'webview') and self.webview:
            try:
                self.display_page()  # Refresh the current page with new colors
            except:
                pass
