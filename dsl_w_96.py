...
class MainWindow(Adw.ApplicationWindow):
    ...
    def _apply_theme_to_webview(self):
        ...
        theme_css = self._get_base_css()
        if dark:
            theme_css = (theme_css
                .replace("VAR_BG", "#1e1e1e")
                .replace("VAR_FG", "#dddddd")
                .replace("VAR_LINK", "#89b4ff")
                .replace("VAR_BORDER", "#444")
                .replace("VAR_POS", "#9ae59a")
                .replace("VAR_EXAMPLE", "#9ae59a"))
        else:
            theme_css = (theme_css
                .replace("VAR_BG", "#ffffff")
                .replace("VAR_FG", "#222222")
                .replace("VAR_LINK", "#005bbb")
                .replace("VAR_BORDER", "#ccc")
                .replace("VAR_POS", "#228B22")
                .replace("VAR_EXAMPLE", "#228B22"))
    ...
    def show_placeholder(self, text):
        ...
        theme_css = self._get_base_css()
        theme_css = (theme_css
            .replace("VAR_BG", "#1e1e1e" if dark else "#ffffff")
            .replace("VAR_FG", "#dddddd" if dark else "#222222")
            .replace("VAR_LINK", "#89b4ff" if dark else "#005bbb")
            .replace("VAR_BORDER", "#444" if dark else "#ccc")
            .replace("VAR_POS", "#9ae59a" if dark else "#228B22")
            .replace("VAR_EXAMPLE", "#9ae59a" if dark else "#228B22"))
