...
class Win(Adw.ApplicationWindow):
    ...
    def apply_column_layout(self, selected_column_index):
        ...
        # This is a simplified approach - for complex HTML you might need more sophisticated parsing
        # For now, we'll just wrap the body content
        ...
        # Create the column layout with the content
        html_content = f"""
        <html>
            <head>
                {css}
